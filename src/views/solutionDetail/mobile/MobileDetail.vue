...
.mobile-detail >>> body > .el-container {
  margin-bottom: 2.5rem;
}

.mobile-detail >>> .el-container:nth-child(5) .el-aside,
.el-container:nth-child(6) .el-aside {
  line-height: 16.25rem;
}

.mobile-detail >>> .el-container:nth-child(7) .el-aside {
  line-height: 20rem;
}

.mobile-detail >>> .el-menu--horizontal .el-menu-item:not(.is-disabled):focus,
